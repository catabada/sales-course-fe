...
import {getCategoriesSearch, requestCreateCategory} from "~/redux/category/categorySlice";
...
function CategoryAdd() {
    ...
    return <Box>
        ...
        >
            <DialogTitle sx={{fontSize: '2.4rem', fontWeight: 'bold'}}> Thêm danh mục mới</DialogTitle>
            <DialogContent>
